...
track.events << MetaEvent.new(META_SEQ_NAME, 'This is the sequence name')
...
track.name = 'This is the track name'
...
[0, 2, 4, 5, 7, 9, 11, 12].each { | offset |
  ...
  track.events << NoteOn.new(0, 64 + 12 + offset, 127, 0)
  track.events << NoteOff.new(0, 64 + offset, 127, quarter_note_length)
  track.events << NoteOff.new(0, 64 + 12 + offset, 127, 0)
}
