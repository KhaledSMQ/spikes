...
namespace WebBrowserExtendedWinForms
{
    ...
    public class ExtendedWebBrowser : WebBrowser
    {
        ...
        {
            get { return _axIWebBrowser2.Height; }
        }

        public int WebBrowserWidth
        {
            get { return _axIWebBrowser2.Width; }
        }
        ...
        {
            EventHandler handler = Downloading;
            if (handler != null)
                handler(this, e);
        }
        ...
        protected void OnStartNavigate(BrowserExtendedNavigatingEventArgs e)
        {
            ...
            EventHandler<BrowserExtendedNavigatingEventArgs> handler = StartNavigate;
            if (handler != null)
                handler(this, e);
        }
